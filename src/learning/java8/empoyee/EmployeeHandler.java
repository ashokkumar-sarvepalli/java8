...
public class EmployeeHandler {
	...
	public Set<Employee> sortEmployeesWithSalaryForGivenManager(String mgrId) {
		return managerMap.get(mgrId).getEmpList().stream().sorted(Comparator.comparing(Employee::getSalary)).collect(Collectors.toSet());
	}
	...
	public Map<String,Integer> countOfEmployeesUnderEachManagerGreaterThanSpecificSalary(double salary){
		Map<String,Integer> employeeUnderEachManagerCount = new HashMap<String,Integer>();
		//
		return employeeUnderEachManagerCount;
	}
